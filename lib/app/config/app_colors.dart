...
class AppColors {
  ...
  static const Color kGrey = Color(0xffAAAFC0);
  ...
  static const Color dimBlack = Colors.black45;

  // static const Color primaryBlue = Color(0xff00A8EA);
  static const Color textBlack = Color(0xff797c7f);
  ...
  static const Color textBlue = Color(0xff1A254F);
  static const Color favouriteColor = Color(0xffc7c9cb);
}
